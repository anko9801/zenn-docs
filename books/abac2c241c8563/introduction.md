...
今まで Crypto を習得する為に、パズルの部分については実際に CTF に出たり writeup を読むことで習得出来ますが、体系化された知識については大量の資料を読むことでしか得る手段がなかったと思います。そこで Crypto のすべての知識を集めたこの記事を用意してみました！私自身ずっとこういうのが欲しかったので助かりました！(？)知識だけとはいえ、パズルもないとわかんないので問題も集めました！ぜひ解いて私に教えてね。
