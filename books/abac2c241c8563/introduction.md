...
Crypto において習得する為にはパズルは実際に CTF に出たり writeup を読むことで習得出来ますが、体系化された知識については大量の資料を読むことでしか得る手段がなかったと思います。そこでこの記事を用意してみました！私自身ずっとこういうのが欲しかったので助かりました！(？)知識だけとはいえ、パズルもないとわかんないので自分の思う良問を集めました！ぜひ解いて教えてね。
