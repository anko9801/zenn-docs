...
https://acompany.tech/privacytechlab/commitment-and-zero-knowledge-proof/
...
- WebAuthn / FIDO
公開鍵認証をブラウザ上で行う為の規格。公開鍵認証に移行してパスワードをこの世から消滅させる目的。Yubico, SoloKey, Nitrokey など。
- マイナンバーカード
...
セキュアな領域と信頼できない領域を分ける。オンラインゲームのチート防止。
