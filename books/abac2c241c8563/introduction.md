...
CTF はコンピューターサイエンスの高度な知識とパズルを解く発想力の両方を問う総合格闘技です！
中でも Crypto は暗号という一見フシギなシステムを攻撃して理解を深める分野です。

Crypto において習得する為に、パズルの部分については実際に CTF に出たり writeup を読むことで習得出来ますが、体系化された知識については大量の資料を読むことでしか得る手段がなかったと思います。そこで Crypto のすべての知識を集めたこの記事を用意してみました！私自身ずっとこういうのが欲しかったので助かりました！(？)知識だけとはいえ、パズルもないとわかんないので自分の思う良問も集めました！ぜひ解いて私に教えてね。
...
- WebAuthn / FIDO
公開鍵認証をブラウザ上で行う為の規格。パスワードなしでログインできるようにする。Yubico, SoloKey, Nitrokey など。
- マイナンバーカード
