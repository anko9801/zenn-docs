...
LLM に調べさせて設計させてコードを書かせたりといろんな作業が速くなり、今一番ボトルネックとなるのは手作業の部分です。そんな中で環境整備はほとんどの人が手作業なんじゃないでしょうか？

環境整備って最初に環境構築して、新しいツールが出たら入れたり盆栽して、PC が変わればまたそれの繰り返しのことで、人によっていろんな工夫をして楽にしていると思うのですが、近年 LLM によってツールがたくさん開発されて良いツールがあるのに管理コストが高くて手が伸びにくいみたいな状況がよくある or これからたくさんあると思います。
