...
よく LLM に調べさせて設計させてコードを書かせたりといろんな作業が速くなりましたが、今一番ボトルネックとなるのは手作業の部分です。そんな中で環境整備はほとんどの人が手作業なんじゃないでしょうか？

環境整備って最初に環境構築して、新しいツールが出たら入れたり盆栽して、PC が変わればまたそれの繰り返しで、人によっていろんな工夫をして楽にしていると思うのですが、近年 LLM によってツールの開発効率が上がって良いツールがあるのに管理コストが高くて使えないと思います。
...
私自身、dotfiles で長いこと設定を管理してきたのですが


シェルスクリプトで管理し始め、chezmoi を試し、Ansible に冪等性の良さを教えてもらい、yadm に移行し、 Nix に落ち着きました。dotfiles の管理方法はこれだけ選択肢があって、どれも一長一短あります。
