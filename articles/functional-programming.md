...
玉石混淆の情報を塊ごとに分けて整理するコロケーション。そうすると 1 つの情報を頭にと言って。それを階層構造は Single Source of Truth と単方向フローの組み合わせですし、も
...
### モナド変換子 (Monad Transformers) と Extensible Effects 
...
Hefty Algebras
Hefty Algebras はこれを解決し、高階作用を含んだ Effect System をきれいに合成可能にするための代数的構造を提供します。
