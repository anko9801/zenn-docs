...
なので落ち着いて情報がいくつあるのかを数えると、仕事の効率が大きく上がります。
...
1. Minimal Reproduction が作りやすい
2. どこまで不具合が起きていないかを確定しやすい
3. 最小の変更で済む
4. テストしやすい
...
それは**変わりやすいものが、変わりにくいものに依存する**ことです。変更の波及を最小化します。これを実践したのがクリーンアーキテクチャで「ドメイン ← ビジネスロジック ← 技術的詳細」と安定性と依存性が一致するように組み立てている。[^clean]
